...
Spieler erkennen sichtbare Hinweise, Anomalien oder Auffälligkeiten, ohne deren genaue Bedeutung zu verstehen.

> [!example] Beispiel
>    - **Erfolg:** Spieler bemerken Hinweise, wie verdächtige Muster, versteckte Fächer, seltsame Geräusche oder sichtbare Fallen.
...
| Schnelle Suche              | Ein kurzer, oberflächlicher Blick                 | +5              | ×1       | Gut für Situationen mit Zeitdruck, übergeht aber leichter Details.                |
| Gründliche Suche            | Gründliches Suchen mit Fokus                      | Keine Änderung  | ×3       | Standard-Methode, deckt die meisten versteckten Hinweise ab.                      |
| Intensive Suche             | Extrem gründliches Untersuchen jedes Details      | -5              | ×10      | Ideal für kritische Momente oder Räume mit Fallen, aber zeitaufwendig.            |
|                             |                                                   |                 |          |                                                                                   |
...
|                             |                                                   |                 |          |                                                                                   |
| **Art der Suche**           |                                                   |                 |          |                                                                                   |
| Sichtbare Inspektion        | Visuelle Kontrolle, ohne direkte Interaktion      | +2              | ×1       | Schnell, aber oft ineffektiv, dafür geringeres Risiko von Fallen.                 |
| Direkte Interaktion         | Aktives Untersuchen durch Berühren, Bewegen etc.  | Keine Änderung  | ×3       | Risiko von Fallen oder Schäden, aber bessere Erfolgschancen bei komplexen Räumen. |
| Kreative Methode            | Spieler beschreiben gezielt, wie sie suchen       | -2 bis -5       |          | Belohnt clevere oder besonders passende Beschreibungen.                           |
|                             |                                                   |                 |          |                                                                                   |
| **Umgebungsfaktoren**       |                                                   |                 |          |                                                                                   |
| Gute Bedingungen            | Helles Licht, aufgeräumter Raum, kein Zeitdruck   | -2              |          | Spieler profitieren von einer angenehmen Umgebung.                                |
| Schlechte Bedingungen       | Dunkelheit, Chaos im Raum, Zeitdruck              | +5              | ×2       | Spieler haben es schwer, Details zu erkennen oder konzentriert zu arbeiten.       |

## Ergebnis einer Suche
| **Würfelergebnis** | **Art der Entdeckung**                                                                                                                       | **Informationen**                 |
| ------------------ | -------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------- |
...
Ein entsprechend hoher Wurf sollte IMMER IRGENDETWAS aufdecken auch wenn normalerweise nichts (mehr) zu finden wäre.